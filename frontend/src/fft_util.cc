...
int FftPopulateState(struct FftState *state, size_t input_size) {
  ...
  //state->output = reinterpret_cast<complex_int8_t *>(
  ...
  //kiss_fft_fixed16::kiss_fftr_cfg kfft_cfg = kiss_fft_fixed16::kiss_fftr_alloc(
  kiss_fft_fixed8::kiss_fftr_cfg kfft_cfg = kiss_fft_fixed8::kiss_fftr_alloc(
  ...
  //kfft_cfg = kiss_fft_fixed16::kiss_fftr_alloc(state->fft_size, 0,
  kfft_cfg = kiss_fft_fixed8::kiss_fftr_alloc(state->fft_size, 0,
